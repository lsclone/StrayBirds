...
<code>class tuple<int, std::vector<int>, std::map<std::string, std::vector<int>>> someInstanceName<\code>



*参考网址*：[C++11中可变参数个数的模板（variadic template）](http://m.blog.csdn.net/blog/herojia_1/10328791 "markdown")

*参考文档*：[C++11标准中文版文档](http://download.csdn.net/detail/herojia_1/6013155 "markdown")
