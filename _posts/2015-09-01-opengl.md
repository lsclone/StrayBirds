...
7.1 [OpenGL ES 2.0 绘制一个三角形(webset)](http://codingnow.cn/opengles/1514.html "opengl es 2.0")

7.2 [OpenGL ES 2.0 绘制一个立方体(github)](https://github.com/lsclone/opengles-book-samples/blob/master/Windows/Chapter_8/Simple_VertexShader/Simple_VertexShader.c "opengl es 2.0")

```
void Update ( ESContext *esContext, float deltaTime ) {
  ...
  //esTranslate( &modelview, 0.0, 0.0, -2.0 );
  //esRotate( &modelview, userData->angle, 1.0, 0.0, 1.0 ); // esRotate旋转和右手定则方向相反
